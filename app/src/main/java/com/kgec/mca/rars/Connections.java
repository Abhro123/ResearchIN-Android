...
public class Connections extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentOfView(R.layout.activity_connections,this);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    Following tab1 = new Following();
                    return tab1;
                case 1:
                    Followus tab2 = new Followus();
                    return tab2;
                default:
                    return null;
