...
// Inflate the layout for this fragment
        ...
        View rootView = inflater.inflate(R.layout.reportedusers, container, false);
    ...
    private void requestfunc() {
        ...
        // showDialog();
        String url = "http://suhrid1theinceptor.000webhostapp.com/scholar_network/reported_user.php?email="+email;
                ...
                try {
                    ...
                    for (int i = 0; i < data1.length(); i++) {
                        try {
                            ...
                            String name = json.getString("reporting");
        ...
        try {
            ...
            for (int i = 0; i < data2.length(); i++) {
                try {
                    ...
                    if (json.getString("reporting").equals(json1.getString("email"))) {
    ...
    public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(CustomAdapter.ViewHolder holder, final int position) {
            ...
            holder.textuser.setText(names.get(position));
